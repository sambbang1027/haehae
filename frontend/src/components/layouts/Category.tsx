    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.content}>
        ...
        <View style={styles.section}>
          ...
          <CategoryItem label="대형폐기물 신청" to={{ stack: 'WasteStack', screen: 'BulkWasteApplyScreen' }} />
          <CategoryItem label="AI 분리배출 가이드" to={{ stack: 'AiDisposalStack', screen: 'AiDisposalEntryScreen' }} />
          <CategoryItem label="배출 제한 가이드" to={{ stack: 'WasteStack', screen: 'WasteRestrictionGuideScreen' }} />
        </View>
